...
public class OrderSummaryActivityTest {
    ...
    private static final String EMAIL_MESSAGE = "I just ordered a delicious tea from TeaTime. Next " +
            "time you are craving a tea, check them out!";
    ...
    public void stubAllExternalIntents() {
        intending(not(isInternal())).respondWith(new ActivityResult(
                Activity.RESULT_OK,
                null));
    }
